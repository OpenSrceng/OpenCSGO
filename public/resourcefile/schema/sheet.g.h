//-----------------------------------------------------------------------------
// Autogenerated by vschema compiler, compiled May 25 2009 11:22:37
...
vschema struct SheetSequence_t
{
	uint32           m_nId;
	bool             m_bClamp;
...
vschema struct SheetSequenceFrame_t
{
	float32          m_flDisplayTime;
	CResourceArray< SheetFrameImage_t > m_Images;
};

vschema struct SheetFrameImage_t
{
	Vector2D         uv[2];
};
