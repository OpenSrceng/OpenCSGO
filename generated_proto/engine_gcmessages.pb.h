...
#ifndef PROTOBUF_INCLUDED_engine_5fgcmessages_2eproto
#define PROTOBUF_INCLUDED_engine_5fgcmessages_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_engine_5fgcmessages_2eproto 
...
class CEngineGotvSyncPacket : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CEngineGotvSyncPacket) */ {
 public:
  ...
  inline CEngineGotvSyncPacket* New() const final {
    return CreateMaybeMessage<CEngineGotvSyncPacket>(NULL);
  }

  CEngineGotvSyncPacket* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_engine_5fgcmessages_2eproto
