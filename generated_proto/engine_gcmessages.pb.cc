...
static void InitDefaultsCEngineGotvSyncPacket() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_CEngineGotvSyncPacket =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsCEngineGotvSyncPacket}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_CEngineGotvSyncPacket.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "engine_gcmessages.proto", schemas, file_default_instances, TableStruct::offsets,
...
const CEngineGotvSyncPacket& CEngineGotvSyncPacket::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_engine_5fgcmessages_2eproto::scc_info_CEngineGotvSyncPacket.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::CEngineGotvSyncPacket* Arena::CreateMaybeMessage< ::CEngineGotvSyncPacket >(Arena* arena) {
  return Arena::CreateInternal< ::CEngineGotvSyncPacket >(arena);
}
}  // namespace protobuf
}  // namespace google
