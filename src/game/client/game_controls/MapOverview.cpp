...
CON_COMMAND_F( overview_zoom, "Sets overview map zoom: <zoom> [<time>] [rel]", FCVAR_CLIENTCMD_CAN_EXECUTE )
{
...
CON_COMMAND_F( overview_mode, "Sets overview map mode off,small,large: <0|1|2>", FCVAR_CLIENTCMD_CAN_EXECUTE )
{
	if ( !GetMapOverView() )
		return;
